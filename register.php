...
<body>
    ...
    <div class="screen">
        <div class="screen__content">
            <form class="login" method="POST" action="root/process">
                <div class="login__field">
                    <i class="login__icon fas fa-user"></i>
                    <input type="email" name="email" class="login__input" required placeholder="Email Address">
                </div>
                <div class="login__field">
                    <i class="login__icon fas fa-user"></i>
                    <input type="text" name="phone" class="login__input" required placeholder="Phone Number">
                </div>
                <div class="login__field">
                ...
                <br>
            <p>Already with Account <a href="login" class="btn btn-danger" style="color: #fff; ">Login</a></p>           
            </form>
            <div class="social-login">
                <br>
                <h3><a href="<?=SITE_URL; ?>" style='text-decoration: none; color: #fff;'>Go Home</a></h3>
